...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{images/hessian.pdf}
...
\begin{enumerate}
    ...
    \item Metoda trust-constr iz paketa SciPy, ki uporablja numerično izračunani gradient in Hessovo matriko ter metodo območja zaupanja \cite{conn2000trust}, ki dopušča linearne omejitve.
\end{enumerate}
...
\begin{figure}
    ...
    \caption{Konvergenca z naključnimi začetnimi točkami}
...
\begin{figure}
    ...
    \caption{Konvergenca z naključnimi točkami in premicami}
